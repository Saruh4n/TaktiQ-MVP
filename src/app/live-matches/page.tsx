          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-left">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Gerçek zamanlı maç skorları</span>
              </div>
              <div className="flex items-center space-x-3">
                <Activity className="w-5 h-5 text-orange-500" />
                <span className="text-gray-700">Canlı oyuncu performansları</span>
              </div>
              <div className="flex items-center space-x-3">
                <BarChart3 className="w-5 h-5 text-orange-500" />
                <span className="text-gray-700">Anlık takım istatistikleri</span>
              </div>
              <div className="flex items-center space-x-3">
                <Wrench className="w-5 h-5 text-orange-500" />
                <span className="text-gray-700">Maç öncesi analizler</span>
              </div>
            </div>
          </div>
