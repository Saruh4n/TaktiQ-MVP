          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="font-bold text-xl text-gray-900">Son Dakika</span>
              </Link>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-left">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Gerçek zamanlı haber akışı</span>
              </div>
              <div className="flex items-center space-x-3">
                <Globe className="w-5 h-5 text-orange-500" />
                <span className="text-gray-700">Uluslararası futbol haberleri</span>
              </div>
              <div className="flex items-center space-x-3">
                <TrendingUp className="w-5 h-5 text-orange-500" />
                <span className="text-gray-700">Trend futbol konuları</span>
              </div>
              <div className="flex items-center space-x-3">
                <Wrench className="w-5 h-5 text-orange-500" />
                <span className="text-gray-700">Kişiselleştirilmiş haber akışı</span>
              </div>
            </div>
          </div>
